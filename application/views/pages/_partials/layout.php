...
<body>
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title">Login sebagai <b><?= $this->session->userdata('role'); ?></b></div>
              <a href="<?= base_url('password'); ?>" class="dropdown-item has-icon">
                <i class="fas fa-fw fa-cog"></i> Ubah Password
              </a>
      ...
      <form id="form-logout" action="<?= base_url('auth/logout'); ?>" method="post" style="display:none;">
      </form>