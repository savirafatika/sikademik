...
<script src="<?php echo base_url(); ?>assets/modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js">
</script>
...
<script src="<?php echo base_url(); ?>assets/modules/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js">
</script>
...
<?php $this->load->view('pages/_partials/scripts/menu');?>
<?php $this->load->view('pages/_partials/scripts/submenu');?>
<?php $this->load->view('pages/_partials/scripts/role');?>
<?php $this->load->view('pages/_partials/scripts/user');?>
<?php $this->load->view('pages/_partials/scripts/siswa');?>
<?php $this->load->view('pages/_partials/scripts/guru');?>
<?php $this->load->view('pages/_partials/scripts/mapel');?>
...
<?php $this->load->view('pages/_partials/scripts/raport');?>
</body>
