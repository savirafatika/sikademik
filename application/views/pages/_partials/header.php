...
<head>
  ...
  <title><?php echo $title; ?> - SIKADEMIK</title>
...
<?php
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/weather-icon/css/weather-icons-wind.min.css">
<?php
}elseif ($this->uri->segment(2) == "auth_login" || $this->uri->segment(1) == "auth" || $this->uri->segment(1) == null) { ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-social/bootstrap-social.css">
<?php
...
if ($this->uri->segment(2) == "layout_transparent") {
  $this->load->view('pages/_partials/layout-2');
  $this->load->view('pages/_partials/sidebar-2');
}elseif ($this->uri->segment(2) == "layout_top_navigation") {
  $this->load->view('pages/_partials/layout-3');
  $this->load->view('pages/_partials/navbar');
}elseif ($this->uri->segment(2) != "auth_login" && $this->uri->segment(1) != "auth" && $this->uri->segment(1) != null && $this->uri->segment(2) != "auth_forgot_password"&& $this->uri->segment(2) != "auth_register" && $this->uri->segment(2) != "auth_reset_password" && $this->uri->segment(2) != "errors_503" && $this->uri->segment(2) != "errors_403" && $this->uri->segment(2) != "errors_404" && $this->uri->segment(2) != "errors_500" && $this->uri->segment(2) != "utilities_contact" && $this->uri->segment(2) != "utilities_subscribe") {
